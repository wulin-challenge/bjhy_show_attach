...
//		
	...
	var renderHtml = function(){
		...
		var html = "<div class='first-panel'>";
			...
			html+= "<a href='javascript:;' class='first-file'>上传文件 11<input type='file' multiple='' name='uploadFile' id='upload-file-id'></a>";
			html+= "</form>";
			html+= "</div>";
			
			html+= "<div class='first-download-zip-div' style='"+showButton('batchDelete')+"'><a id='first-download-zip-id' class='first-download-zip' href='javascript:;'>批量下载22</a></div>";
			html+= "<div class='first-del-div' style='"+showButton('batchDelete')+"'><a id='first-batch-del-id' class='first-del' href='javascript:;'>批量删除33</a></div>";
